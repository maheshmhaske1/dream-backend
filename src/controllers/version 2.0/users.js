...
const { use, all } = require("../../routes/likes");
...
//     const allFriends=await UserFriend.findAll({ where: { user_id: senderId }})
//     // const allFriend = await UserFriend.findAll({
...
// const isFriendIdIncluded = allFriends.some(item => item.friend_id === recipientId);
// const isGift = gifts.some(item => item.id === recipientId);


//     if (!isFriendIdIncluded) {
